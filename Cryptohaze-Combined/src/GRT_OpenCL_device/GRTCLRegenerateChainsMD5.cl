...
// Don't know why Apple OpenCL wants definitions, but it does.
void searchForHash(uint a, uint b, uint c, uint d, uint vectorPosition,
...
inline void searchForHash(uint a, uint b, uint c, uint d, uint vectorPosition,
        LOCAL_MEMORY_TYPE unsigned char *sharedBitmap,
        uint deviceNumberOfHashes, __global unsigned int *deviceHashArray,
        __global   unsigned char *foundPasswordArray, __global  unsigned char *deviceSuccessArray,
        uint b0, uint b1, uint b2, uint b3) {
...
__kernel __attribute__((vec_type_hint(vector_type))) void RegenerateChainsMD5AMD(
    ...
    for (PassCount = 0; PassCount < deviceStepsToRun; PassCount++) {
        ...
        searchForHash(a.s0, b.s0, c.s0, d.s0, 0, BITMAP_NAME, deviceNumberOfHashes, deviceHashArray, foundPasswordArray, deviceSuccessArray,
                b0.s0, b1.s0, b2.s0, b3.s0);
#endif
#if grt_vector_2 || grt_vector_4 || grt_vector_8 || grt_vector_16
        searchForHash(a.s1, b.s1, c.s1, d.s1, 1, BITMAP_NAME, deviceNumberOfHashes, deviceHashArray, foundPasswordArray, deviceSuccessArray,
                b0.s1, b1.s1, b2.s1, b3.s1);
#endif
#if grt_vector_4 || grt_vector_8 || grt_vector_16
        searchForHash(a.s2, b.s2, c.s2, d.s2, 2, BITMAP_NAME, deviceNumberOfHashes, deviceHashArray, foundPasswordArray, deviceSuccessArray,
                b0.s2, b1.s2, b2.s2, b3.s2);
        searchForHash(a.s3, b.s3, c.s3, d.s3, 3, BITMAP_NAME, deviceNumberOfHashes, deviceHashArray, foundPasswordArray, deviceSuccessArray,
                b0.s3, b1.s3, b2.s3, b3.s3);
#endif
#if grt_vector_8 || grt_vector_16
        searchForHash(a.s4, b.s4, c.s4, d.s4, 4, BITMAP_NAME, deviceNumberOfHashes, deviceHashArray, foundPasswordArray, deviceSuccessArray,
                b0.s4, b1.s4, b2.s4, b3.s4);
        searchForHash(a.s5, b.s5, c.s5, d.s5, 5, BITMAP_NAME, deviceNumberOfHashes, deviceHashArray, foundPasswordArray, deviceSuccessArray,
                b0.s5, b1.s5, b2.s5, b3.s5);
        searchForHash(a.s6, b.s6, c.s6, d.s6, 6, BITMAP_NAME, deviceNumberOfHashes, deviceHashArray, foundPasswordArray, deviceSuccessArray,
                b0.s6, b1.s6, b2.s6, b3.s6);
        searchForHash(a.s7, b.s7, c.s7, d.s7, 7, BITMAP_NAME, deviceNumberOfHashes, deviceHashArray, foundPasswordArray, deviceSuccessArray,
                b0.s7, b1.s7, b2.s7, b3.s7);
#endif
