...
void CHHashFileVPlainLM::ImportHashListFromRemoteSystem(::google::protobuf::Message & remoteData) {
    printf("CHHashFileVPlainLM::ImportHashListFromRemoteSystem()\n");
}

void CHHashFileVPlainLM::ExportHashListToRemoteSystem(::google::protobuf:: Message &exportData) {
