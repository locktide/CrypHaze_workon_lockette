...
#ifndef _GRTCLREGENERATECHAINSMD5_H
#define _GRTCLREGENERATECHAINSMD5_H
...
class GRTCLRegenerateChainsMD5 : public GRTCLRegenerateChains {
private:


public:
    // Default constructor
    GRTCLRegenerateChainsMD5();
