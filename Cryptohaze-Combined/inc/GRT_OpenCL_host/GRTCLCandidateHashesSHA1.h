...
#ifndef _GRTCLCANDIDATEHASHESSHA1_H
#define _GRTCLCANDIDATEHASHESSHA1_H
...
class GRTCLCandidateHashesSHA1 : public GRTCLCandidateHashes {
private:


public:
    // Default constructor
    GRTCLCandidateHashesSHA1();
