...
#ifndef _GRTCLREGENERATECHAINSNTLM_H
#define _GRTCLREGENERATECHAINSNTLM_H
...
class GRTCLRegenerateChainsNTLM : public GRTCLRegenerateChains {
private:


public:
    // Default constructor
    GRTCLRegenerateChainsNTLM();
