...
#ifndef _GRTCLCANDIDATEHASHESNTLM_H
#define _GRTCLCANDIDATEHASHESNTLM_H
...
class GRTCLCandidateHashesNTLM : public GRTCLCandidateHashes {
private:


public:
    // Default constructor
    GRTCLCandidateHashesNTLM();
