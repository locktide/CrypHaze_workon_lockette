...
#ifndef _GRTCLREGENERATECHAINSSHA1_H
#define _GRTCLREGENERATECHAINSSHA1_H
...
class GRTCLRegenerateChainsSHA1 : public GRTCLRegenerateChains {
private:


public:
    // Default constructor
    GRTCLRegenerateChainsSHA1();
