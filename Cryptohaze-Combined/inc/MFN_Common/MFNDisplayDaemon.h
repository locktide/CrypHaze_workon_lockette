...
#ifndef __MFNDISPLAY_DAEMON_H
#define __MFNDISPLAY_DAEMON_H

#include "MFN_Common/MFNDisplay.h"


class MFNDisplayDaemon : public MFNDisplay {
public:
    MFNDisplayDaemon();
    ~MFNDisplayDaemon();
    ...
    virtual void alterNetworkClientCount(uint16_t networkClientCount);
};
