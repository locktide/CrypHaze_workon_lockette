...
for ($passwordLength = 0; $passwordLength < $maxPasswordLength; $passwordLength++) {
    ...
    print "#define makeMFNSingleIncrementorsNTLM" . ($passwordLength + 1) . "(charsetForward, charsetReverse, charsetLengths) {\\\n";
...
for ($passwordLength = 0; $passwordLength < $maxPasswordLength; $passwordLength++) {
    ...
    print "#define makeMFNMultipleIncrementorsNTLM" . ($passwordLength + 1) . "(charsetForward, charsetReverse, charsetLengths) {\\\n";
