...
for ($passwordLength = 0; $passwordLength < $maxPasswordLength; $passwordLength++) {
    ...
    print "#define makeMFNSingleIncrementors" . ($passwordLength + 1) . "(charsetForward, charsetReverse, charsetLengths) {\\\n";
...
for ($passwordLength = 0; $passwordLength < $maxPasswordLength; $passwordLength++) {
    ...
    print "#define makeMFNMultipleIncrementors" . ($passwordLength + 1) . "(charsetForward, charsetReverse, charsetLengths) {\\\n";
