 ...
 * @section DESCRIPTION
 *
 * This file implements common CUDA MD5 functions.
 * These are separate from OpenCL as they are not vector-types
 */
 ...
 * beginning, performs the full block, and makes the final additions.
 */
